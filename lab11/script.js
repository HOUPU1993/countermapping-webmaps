...
// First:create the function about format
var initLoad = true;
var layerTypes = {
    'fill': ['fill-opacity'],
    'line': ['line-opacity'],
...
// Second:create cite element and add <div></div> into the index.html
...
// Third:about your header, that section of the page currently containing the next "Coastal Flooding in New York City" etc.
...
// Fourth:It's basically adding the chapter title, image, description and setting the theme. It is also giving each chapter the step class and also sets the first chapter to be active
